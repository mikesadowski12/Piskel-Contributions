(function () {
  ...
  ns.FrameRenderer.prototype.setZoom = function (zoom, cursorX, cursorY) {
    ...
    var centerX = this.offset.x + (cursorX / this.zoom);
    var centerY = this.offset.y + (cursorY / this.zoom);
    ...
    this.setOffset(
      ...
      centerX - (cursorX / this.zoom),
      centerY - (cursorY / this.zoom)
    );
  };
