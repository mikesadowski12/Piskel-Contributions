(function () {
  ...
  ns.GifExportController.prototype.init = function () {
    ...
    this.twitterCheckbox = document.querySelector('.checkbox');
    ...
    this.addEventListener(this.twitterCheckbox, 'click', this.onTwitterCheckboxClick_);
  };
  
  ns.GifExportController.prototype.init = function (width, height) {
  ...
  ns.GifExportController.prototype.onTwitterCheckboxClick_ = function (evt) {
    if(this.twitterCheckbox.checked === true) {
      this.widthInput.value = '512';
      this.heightInput.value = '512';
