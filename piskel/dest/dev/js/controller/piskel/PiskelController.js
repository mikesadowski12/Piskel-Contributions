(function () {
  ...
  ns.PiskelController.prototype.setFrameHeight = function (height) {
    ns.FrameInformation.setFrameHeight(height);
  };

  ns.PiskelController.prototype.setFrameWidth = function (width) {
    ns.FrameInformation.setFrameWidth(width);
  };

  ns.PiskelController.prototype.getFrameHeight = function () {
    return ns.FrameInformation.getFrameHeight();
  };

  ns.PiskelController.prototype.getFrameWidth = function () {
    return ns.FrameInformation.getFrameWidth();
  };
  ...
  ns.PiskelController.prototype.addFrameAtCurrent = function (frames, index) {
    this.getLayers().forEach(function (l) {
      l.addFrameAt(frames, index);
    }.bind(this));
