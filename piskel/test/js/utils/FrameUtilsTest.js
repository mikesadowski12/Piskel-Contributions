describe("FrameUtils suite", function() {
  ...
  /*
  it("place correct number of zero padding", function() {
    var padding = pskl.controller.settings.exportimage.PngExportController.getPaddedZeros_(1000, 12);
    expect(padding).toBe('00');
  });
  */
