(function () {
  ...
  ns.DrawingController.prototype.onMousemove_ = function (event) {
    // save the co-ordinates of the cursor
    this.cursorX = event.pageX - $('#drawing-canvas-container').offset().left;
    this.cursorY = event.pageY - $('#drawing-canvas-container').offset().top;
  ...
  ns.DrawingController.prototype.setZoom_ = function (zoom) {
    this.compositeRenderer.setZoom(zoom, this.cursorX, this.cursorY);
    $.publish(Events.ZOOM_CHANGED);
  };
